...
Все пароли: **см. backend/demo_password.txt**
...
1. **Регистрация/Вход**: http://localhost:3000
   - Попробуйте войти как `igor@delo.ru`
...
1. **Войдите как заказчик** (`anna@delo.ru` )
2. **Создайте задание** на сумму 10,000₽
3. **Выйдите и войдите как специалист** (`igor@delo.ru` )
